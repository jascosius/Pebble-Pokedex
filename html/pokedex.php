      ...
      <div id="second_lang" data-role="fieldcontain">
        <fieldset data-role="controlgroup" data-type="horizontal" data-mini="true">
          ...
          <?php
            ...
            echo '<input id="second_lang_eng" name="second_lang" value="0" data-theme="" type="radio"' . $lang_eng . $lang_eng_disabled . '><label for="second_lang_eng">English</label>';
            echo '<input id="second_lang_ger" name="second_lang" value="1" data-theme="" type="radio"' . $lang_ger . $lang_ger_disabled . '><label for="second_lang_ger">German</label>';
            echo '<input id="second_lang_none" name="second_lang" value="-1" data-theme="" type="radio"' . $lang_none . '><label for="second_lang_none">None</label>';
	      ?>
        </fieldset>
      </div>
    </div>
